...
const ClientSide = () => {
	...
	if (isSuccessful) {
		return (
			<ThankYouPage
				content='Your free guide, "The AI Advantage," is on its way to your inbox. In the meantime, feel free to explore our website or [schedule a free consultation] to discuss how AI can transform your business. We look forward to helping you unlock your digital potential!'
			/>
		);
	} else {
		return (
